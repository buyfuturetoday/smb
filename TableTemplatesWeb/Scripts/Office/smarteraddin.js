...
//            loginMethod = "smb";
    ...
    function loginSMB() {
       ...
       // var loginURL = "http://buyfuturetoday.com/smb/check_login.php?email=" + userName + "&password=" + password + "&login_method=" + loginMethod;
        var loginURL = "https://smarter-biz.com/check_login.json?x=" + randomh + "&email=" + userName + "&password=" + password + "&login_method=" + loginMethod + "&ver=3";
...
//        var aurl = "https://smarter-biz.com/api/getdumpusers_mails?x=" + randomh + "&user_id=" + userid + "&start_date=" + startdatetoapi + "&end_date=" + endnowUtc + "";
        ...
        $.ajax({
            ...
            url: "https://smarter-biz.com/api/getdumpusers_mails?x=" + randomh + "&user_id=" + userid + "&start_date=" + startdatetoapi + "&end_date=" + endnowUtc + "",
            dataType: "json",
            async: false,
            success: function (data) {
                //syncAgents(data);
            ...
            error: function (xhr) {
                app.showNotification('Error:', JSON.stringify(xhr.responseText));
            }
        });
    }
